...
const staleCallbackLogState = new Map();
...
export function isStaleCallbackQueryError(error) {
...
export function describeCallbackQuerySource(callbackData) {
    if (!callbackData) {
...
function buildCallbackDetails(ctx, options) {
    const details = [];
...
export function logCallbackQueryError(ctx, error, options) {
...
export function resetCallbackQueryLogStateForTests() {

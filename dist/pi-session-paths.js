...
export function resolveSessionPathForRuntime(sessionPath) {
...
export function readSessionHeader(sessionPath) {
    try {
...
export function resolveWorkspacePathForRuntime(workspace) {
    if (!workspace) {
        return undefined;
    }
